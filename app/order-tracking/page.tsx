...
export const metadata: Metadata = {
  ...
  description:
    'Kiểm tra trạng thái đơn hàng của bạn tại Vinyl Sài Gòn. Tra cứu quá trình xử lý, vận chuyển và giao hàng nhanh chóng, chính xác.',
  openGraph: {
    title: 'Tra cứu đơn hàng | Vinyl Sài Gòn',
    description:
      'Kiểm tra trạng thái đơn hàng của bạn tại Vinyl Sài Gòn. Tra cứu quá trình xử lý, vận chuyển và giao hàng nhanh chóng, chính xác.',
    type: 'website',
    ...
    images: [
      {
        ...
        width: 2048,
        height: 1366,
        alt: 'Tra cứu đơn hàng Vinyl Sài Gòn',
      },
    ],
  },
  twitter: {
