...
const description = 'Khám phá câu chuyện hình thành và phát triển của 3K Shop - cửa hàng tai nghe và thiết bị âm thanh chuyên nghiệp tại TP.HCM từ năm 2011. Chuyên cung cấp tai nghe cao cấp, mâm đĩa than, DAC/Amp chính hãng với dịch vụ tư vấn chuyên sâu.'
export const metadata: Metadata = {
  title: 'Giới thiệu',
  description,
  openGraph: {
    title: 'Giới thiệu | 3K Shop',
    description,
    type: 'website',
    ...
    <div className='w-full'>
      ...
      <div className='max-w-screen-lg mx-auto mt-4 lg:mt-6'>
        <div className='container max-w-3xl mx-auto py-8 px-4'>
          <h1 className='text-3xl font-bold mb-6'>Giới thiệu về 3K Shop</h1>
          <div className='page-content'>
            <p className='my-3'>
              Năm 2011, thời điểm mà ở Hồ Chí Minh không có nhiều cửa hàng headphone cũng như nhiều
              mẫu mã để người chơi lựa chọn, đó chính là thời điểm mà 3K Shop đã ra đời. 3K Shop
              ...
              người thành lập shop. Tuy nhiên, mọi người gọi trại riết thành 3K Shop và cuối cùng
              anh em cũng quyết định đổi tên thành 3K Shop và năm 2012, đó cũng là lúc mà website
              vinylsaigon.vn ra đời.
            </p>
            <p className='my-3'>
              Thời điểm đầu tiên, 3K Shop chỉ là 1 cửa hàng nhỏ tại nhà số 443/34 Điện Biên Phủ,
            ...
            <p className='my-3'>
              Tháng 6 năm 2012: 3K Shop mở chi nhánh 14 Nguyễn Văn Giai, P. Đa Kao, Q.1.
            </p>
            <p className='my-3'>
              Một trong những điều quan trọng nhất mà 3K Shop mong muốn nhất chính là mang đến những
              sản phẩm có chất lượng tốt; “tốt” ở đây chính là về cả chất âm, độ bền cũng như chế độ
              bảo hành, hậu mãi cho khách hàng. Chính vì vậy, 3K Shop luôn cố gắng làm việc để đem
              đến những sản phẩm chính hãng cùng với giá thành tốt nhất. Các sản phẩm có chất lượng
              không tốt chắc chắn sẽ không bao giờ hiện hữu tại 3K Shop. Đồng thời, các bạn làm việc
              tại 3K Shop luôn mang trong mình niềm đam mê cũng như cố gắng trang bị những kiến thức
