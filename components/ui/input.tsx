...
function Input({
  ...
  selectionColor,
  ...props
}: React.ComponentProps<'input'> & { selectionColor?: boolean }) {
  return (
    <input
      type={type}
      data-slot='input'
      className={cn(
        ...
        'focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[1.25px] ring-red-200',
        'aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive',
        selectionColor ? 'selection:bg-primary selection:text-primary-foreground' : '',
        className,
      )}
      {...props}
    />
